...
- **Status:** Complete (archived 2026-07-30)
- **Target:** Native SwiftUI application with full Bubble Tea TUI workflow parity
- **Last updated:** 2026-07-30
- **Implementation tracker:** [native-macos-frontend-implementation.md](./native-macos-frontend-implementation.md)
...
Completed plans that previously occupied the repository root are retained as design history under [plans/archive](./).
